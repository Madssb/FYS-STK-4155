...
lr = 0.001
momentum = 0.9
unique_model_dir = model_dir+'cloudnet28_{}epochs_augment{}_center{}_optimizer{}_lr{}mom{}'.format(num_epochs, 
                                                                                        augmentation,
                                                                                        center, 
                                                                                        optimizer_name,
                                                                                        lr,
...
for file in Name:
    ...
    for im in os.listdir(path):
        ...
        image=load_img(os.path.join(path,im), grayscale=False, color_mode='rgb', target_size=(28,28)) 
...
model.add(layers.Conv2D(filters=96, kernel_size=(7, 7), activation='relu', input_shape=(28, 28, 3), strides=(1,1)))
